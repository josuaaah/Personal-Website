...
const thirdIntern = {
  ...
  company: "Hobnob.ai",
  period: "Aug - Dec 2022",
  description: `This company is a startup that provides a website for the scheduling of intra-company networking sessions. 
...
const secondIntern = {
  ...
  company: "WaveScan",
  period: "May - Jul 2022",
  description: `This A*STAR spin-off company specializes in the R&D of smart sensor systems using advanced AI. 
   I developed and redesigned a Desktop application that allows 2D/3D visualizations of scanned wave data.`,
...
const firstIntern = {
  ...
  period: "May - Jul 2021",
  description: `I contributed to the full-stack development of a Human Resource Management System (HRMS). 
...
const mstf = {
  ...
  description: `I maintained large data archives with Microsoft Excel and operate maritime data analysis 
