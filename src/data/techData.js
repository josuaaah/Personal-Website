import AngularJsLogo from '../images/angularjs_logo.png'
...
export let reactIcon = {
  name: "React",
  src: ReactLogo,
};

export let postgreSqlIcon = {
  name: "PostgreSQL",
  src: PostgreSqlLogo,
};

export let hasuraIcon = {
  name: "Hasura",
  src: HasuraLogo,
};

export let djangoIcon = {
  name: "Django",
  src: DjangoLogo,
};

export let angularJsIcon = {
  name: "AngularJS",
  src: AngularJsLogo,
};

export let mySqlIcon = {
  name: "MySQL",
  src: MySqlLogo,
};

export let pygameIcon = {
  name: "Pygame",
  src: PygameLogo,
};

export let rubyOnRailsIcon = {
  name: "Ruby On Rails",
  src: RubyOnRailsLogo,
};

export let tkinterIcon = {
  name: "tkinter",
  src: PythonLogo,
};

export let pythonIcon = {
  name: "Python",
  src: PythonLogo,
};
